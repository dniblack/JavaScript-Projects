{
var x = 45 // created a globalvariable and gave it a value
function Multi_Numebers_1() { // created and labeled a function
    document.write(145 * x + "<br>"); // used document.write to return the total of the global 
            // variable times the interger inside the parantheses; added a line break for organization
}
function Multi_Numebers_2() { // created and labeled a function
    ...
    // variable times the interger (which has an exponent of 2) inside the parantheses; added a line break for organization
}
Multi_Numebers_1();
Multi_Numebers_2();
}
...
function Multi_Numebers_3() { // created and labeled a function
    var x = 45 // created a localvariable and gave it a value of 45
    document.write(145 * x + "<br>"); // used document.write to return the total of the global 
    // variable times the interger inside the parantheses; added a line break for organization
}
function Multi_Numebers_4() { // created and labeled a function
    ...
    // which was purposefully created to show that the variable x needs to be defined; added a line break for organization
}
Multi_Numebers_3();
Multi_Numebers_4();

function Time_function() { // created and labeled the function
    var Time = new Date().getHours(); // created a variable with the value of a date method (.getHours)
    var Reply; // created and labeled a variable
