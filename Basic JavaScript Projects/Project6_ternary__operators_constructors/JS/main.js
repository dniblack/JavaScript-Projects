...
function Voting_Function() { // created and labeled a function
    var Age, Can_Vote; // created and labled two variable
    Age = document.getElementById("Age").value; // gave a value to the first variable; value grabs the button id from the linked HTML 
    Can_Vote = (Age < 18) ? "You are too young":"You are old enough"; // gave a value to the second var; created a condition with the first varaible and a value then added a tenary operator
...
var Cloud = new Limit("Braver", "Level 1", 745); // generated a varaible, Cloud, and created new objects for the varaible
var Tifa = new Limit("Meteor Strike", "Level 3", 4500);  // generated a varaible, Tifa, and created new objects for the varaible
var Barret = new Limit("Hammer Blow", "Level 2", 1455); // generated a varaible, Barret, and created new objects for the varaible
...
function eye_function() { //  created and labeled a function 
    ...
    function Cont() { // created and labeled a fucntion
       var Starting_point = "An eye for an eye "; // created and labeled a varaible and gave it a string value
       function Blind() {Starting_point += "makes the whole world go blind."}
       Blind(); // created and labeled a nested function which will call upon the previous varaible & add another string to it
       return Starting_point; // returns the new variable wit the added string
    }
}