function increment_math() { // Naming and defining the function
    var x = 4 * 7;          // Defining thevariable and giving it an interger value
    x++;                    // icnreased the variable with the incremement operator
...
function decrement_math() { // Naming and defining the function
    var dec = 4 + 5 * 5; // Defining thevariable and giving it an interger value
                        // following PEMDAS, the multiplication will be done first followed by the addition
    dec--;              //decreased the variable using the decremement operator
...
function more_Operator() { // Naming and defining the function
    var simple_Math = (1 + 4) * 4 - 6 / 2; // Defining thevariable and giving it an interger value; used the multiplication, addition, subtraction, and addition operator
...
function modulus_Operator() { // Naming and defining the function
    var modulus_Math = 45 % 4; // Defining thevariable and giving it an interger value; used the mudulous operator
